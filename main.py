...
def contact():
    mess._show(title='Contact us', message="Please contact us on : 'nareshboda659@gmail.com' ")
...
window.configure(background='#1a2e9a')

frame1 = tk.Frame(window, bg="#F5E410")
frame1.place(relx=0.11, rely=0.17, relwidth=0.39, relheight=0.80)

frame2 = tk.Frame(window, bg="#F5E410")
frame2.place(relx=0.51, rely=0.17, relwidth=0.38, relheight=0.80)

message3 = tk.Label(window, text="Smart Attendance Management System" ,fg="white",bg="#2d420a" ,width=55 ,height=1,font=('comic', 29, ' bold '))
...
datef = tk.Label(frame4, text = day+"-"+mont[month]+"-"+year+"  |  ", fg="#ff61e5",bg="#2d420a" ,width=75 ,height=1,font=('comic', 15, ' bold '))
